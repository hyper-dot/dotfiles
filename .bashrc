...
__bash_prompt() {
    local gitbranch='`\
        if git rev-parse --is-inside-work-tree >/dev/null 2>&1; then \
            ...
            echo -n "\[\033[0;36m\](\[\033[0;31m\]$branch\[\033[0;36m\]) "; \
    ...
    PS1="${lightgreen}➜ ${lightblue}\W ${gitbranch}${removecolor}"
...
alias ga='git add .'
alias gcap='function _gcap() { git commit -m "$*"; }; _gcap'
...
alias fpiq='ssh -i ~/Documents/piq-frontend.pem ubuntu@35.178.92.144'
alias bpiq='ssh -i ~/Documents/piq-backend.pem ubuntu@3.9.8.217'
alias sand='ssh -i ~/Documents/sandconsole.pem  root@143.244.150.92'
